...
import com.example.androidlabs.adapters.LatestNewsAdapter;
import com.example.androidlabs.data.ItemDbHelper;
import com.example.androidlabs.data.ItemsContract;
...
public class LatestNewsActivity extends com.example.androidlabs.NewsActivity {
    ...
    public class ChooseFavArticleClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Toast toast = Toast.makeText(LatestNewsActivity.this, R.string.savetofaforite, Toast.LENGTH_SHORT);
            toast.show();
        }
    }
